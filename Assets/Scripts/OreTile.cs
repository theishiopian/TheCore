...
public class OreTile : TileBase
{
    ...
    [MenuItem("Assets/Create/Ore Tile")]
    public static void CreateAnimatedTile()
    {
        //this part opens a save panel
        string path = EditorUtility.SaveFilePanelInProject("Save Ore Tile", "New Ore Tile", "asset", "Save Ore Tile", "Assets");
        if (path == "")
